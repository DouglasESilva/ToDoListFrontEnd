...
const Perfil = () => {
    ...
    const savePerfil = () => {
        ...
        console.log("Antes de salvar:", perfil);
        setSubmitted(true);
    ...
    const deletePerfil = () => {
        console.log("Deletando perfil:", perfil.id);
        ...
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    ...
                    <Dialog visible={perfilDialog} style={{ width: '450px' }} header="Detalhes de Perfis" modal className="p-fluid" footer={perfilDialogFooter} onHide={hideDialog}>
                        <div className="field">
                            ...
                            />
                            {submitted && !perfil.descricao && <small className="p-invalid">Descrição é Obrigatorio.</small>}
                        </div>
                    </Dialog>
